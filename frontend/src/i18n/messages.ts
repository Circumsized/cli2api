...
export const messages: Record<Lang, Dict> = {
  en: {
    ...
    forceRoute: 'Force route',
    forceRouteHint: 'Keep using this account even after its credits run out. Some models do not consume credits; a request to a credit-consuming model fails over to another account instead of failing.',
  ...
  zh: {
    ...
    forceRoute: '坚持调用',
    forceRouteHint: '额度用尽后仍继续使用该账号。部分模型不消耗积分；遇到消耗积分的模型时会自动切换到其他账号，而不是直接失败。',
    checkinNow: '立即签到',
    lastCheckin: '最近签到',
